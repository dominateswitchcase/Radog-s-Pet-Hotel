...
<div class="dashboard-shell d-flex min-vh-100">
    ...
    <aside class="sidebar d-flex flex-column p-4" style="background-color: #F5E7C6;">
        ...
        <nav class="nav nav-pills flex-column mb-auto sidebar-nav">
            ...
            <a href="staff_checkout.php" class="nav-link d-flex align-items-center mb-2 active" style="background-color: #FA8112; color: white;"><i class="bi bi-cash-stack me-3"></i> Checkout/Payments</a>
