    ...
    <body>
        ...
        <nav class="nav nav-pills flex-column mb-auto sidebar-nav">
            ...
            <a href="staff_calendar.php" class="nav-link d-flex align-items-center mb-2 active" style="background-color: #FA8112; color: white;"><i class="bi bi-calendar3 me-3"></i> Calendar</a>
