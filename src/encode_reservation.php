...
<body>
    <aside class="sidebar d-flex flex-column p-4">
        ...
        <nav class="nav nav-pills flex-column mb-auto sidebar-nav">
            ...
            <a href="encode_reservation.php" class="nav-link d-flex align-items-center mb-2 active" style="background-color: #FA8112; color: white;"><i class="bi bi-calendar-check me-3"></i> Schedule</a>
                    ...
                    <div class="bg-panel p-4 h-100 shadow-sm">
                        ...
                        <?php if (isAdmin()): ?>
                            <div class="form-check form-switch mt-3 text-center">
                                <input class="form-check-input" type="checkbox" id="overrideSwitch" name="override" value="1">
                                <label class="form-check-label small" for="overrideSwitch">Force Book (Admin override availability)</label>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
